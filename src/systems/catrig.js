...
// ============================================================
// 🐱🚗 CATRIG — «оживлення котика» (v1.0)
// Для «Котик за кермом» (Оболонь). Замінює статичний inline-SVG #car
// (26×40 CSS-px, тільки rotate()) на більший, деталізованіший силует
// і додає йому дрібні живі рухи щокадру.
//
// Художній напрям: docs/ARTBIBLE.md («Бурштинова діорама») + канон
// docs/UNIVERSE.md §7.1 — авто помаранчеве, вушка над дахом, хвіст-антена.
//
// Бачить глобали гри й нічого з них не перевизначає:
